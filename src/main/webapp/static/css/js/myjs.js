...
Showbo.Msg={
    ...
    InitMsg:function(width){
        ...
        var ifStr='<iframe src="javascript:false" mce_src="javascript:false" style="position:absolute; visibility:inherit; top:0px;left:0px;width:100%; height:100%; z-index:-1;'
            ...
            html='<div class="myjs-top"><div class="myjs-right"><div class="myjs-title" id="dvMsgTitle"></div></div></div>'+
                '<div class="myjs-body"><div class="myjs-right"><div class="myjs-ct" id="dvMsgCT"></div></div></div>'+
                '<div class="myjs-bottom" id="dvMsgBottom"><div class="myjs-right"><div class="myjs-btn" id="dvMsgBtns"></div></div></div>';
    ...
    createBtn:function(p,v,fn){
        ...
        btn.type="button";
        btn.className='myjs-btn';
        btn.value=v;
        btn.onmouseover=function(){this.className='myjs-btnfocus';}
        btn.onmouseout=function(){this.className='myjs-btn';}
    ...
    show:function(cfg){
        ...
        if(cfg.wait){
            ...
            this.dvCT.innerHTML+='<div class="myjs-pro"><div class="myjs-bg" id="dvProcessbar"></div></div>';
            ...
            if(cfg.icon)this.dvCT.innerHTML='<div class="myjs-icon '+cfg.icon+'"></div>';
            if(cfg.msg)this.dvCT.innerHTML+=cfg.msg+'<div class="myjs-clear"></div>';
            this.dvBottom.style.height='45px';
            this.dvBtns.innerHTML='<div class="myjs-height"></div>';
            if(cfg.buttons.yes){
    ...
    onResize:function(isResize){
        ...
        {
            Showbo.Msg.dvMsgBox.style.top=175+"px";
        }
