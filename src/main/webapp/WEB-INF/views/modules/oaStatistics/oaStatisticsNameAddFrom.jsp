...
<body>
    ...
    <form:form id="inputForm" modelAttribute="oaStatisticsName" action="${ctx}/OaStatistics/oaStatistics/save" method="post" class="form-horizontal"  onsubmit="return verification()">
