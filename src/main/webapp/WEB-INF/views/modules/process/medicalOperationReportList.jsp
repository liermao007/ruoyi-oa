...
<form:form id="searchForm" modelAttribute="medicalOperationReport" action="${ctx}/process/medicalOperationReport/"
    ...
    <ul class="ul-form">
        <li class="btns">日期: <input id="currentSumDate" name="currentSumDate" type="text" readonly="readonly"
                                    maxlength="20"
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                ...
                <table id="contentTable1" class="table table-striped table-bordered2 table-condensed" align="center">
                    <thead>
                    <tr>
                        <th style="border-left:none; width:8%;"></th>
                ...
                <table id="contentTable3" class="table table-striped table-bordered2 table-condensed">
                    <thead>
                    <tr>
                        <th style="border-left:none; width:8%;"></th>
                ...
                <table id="contentTable4" class="table table-striped table-bordered2 table-condensed">
                    <thead>
                    <tr>
                        <th style="border-left:none; width:8%;"></th>
...
//        sumAllTableContentTable6(total, "averageNmrSum", 12, 10)
    ...
    //求和，计算百分比
    /*function residueAllTableTD8(flag1, flag2, flag3) {
        if(Number((document.getElementById(flag3).innerHTML))== 0){
            document.getElementById(flag1).innerHTML ="0"
        }else{
            document.getElementById(flag1).innerHTML =((Number((document.getElementById(flag2).innerHTML == "" ? "0" : document.getElementById(flag2).innerHTML)) / Number((document.getElementById(flag3).innerHTML == "" ? "0" : document.getElementById(flag3).innerHTML))))*100;
