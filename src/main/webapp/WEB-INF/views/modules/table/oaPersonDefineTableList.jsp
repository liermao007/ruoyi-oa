...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="oaPersonDefineTable">
			<tr>
                <td><a href="${ctx}/table/oaPersonDefineTable/form?id=${oaPersonDefineTable.id}">${fns:getDictLabel(oaPersonDefineTable.office.id,'act_category','无分类')}</a></td>
                <th>${fns:getDictLabel(oaPersonDefineTable.tableProperty,'act_type','无分类')}</th>
				<td>
