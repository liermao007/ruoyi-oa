...
<div style="background-color: #ffffff">
    <table class="table">
        <tr class="tr1">
            <td colspan="3" style="padding-left: 15px;">转发邮件</td>
        </tr>
        <tr>
        ...
        <form:form modelAttribute="mailInfo" action="" method="post" id="form1"
            ...
            <tr>
                ...
                <td class="td"><form:input path="theme" htmlEscape="false" type="text"
                                           style="width:800px" value="转发：${mailInfo.theme}" id="theme"></form:input></td>
            </tr>
            <tr>
                <td class="td1">附件</td>
                <td class="td" style="padding-bottom: 15px; height: 25px">
                    <c:if test="${not empty mailInfo.files}">
                        ...
                        <input type="hidden" id="FJMC" value="${mailInfo.filesName}"  name="FJMC" htmlEscape="false" maxlength="2000" class="input-xlarge"/>
