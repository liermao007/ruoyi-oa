...
<div style="width: 700px;float: left;">
	<form:form id="inputForm" modelAttribute="oaRunProcess" action="${ctx}/test1/oaRunProcess/selectCheck?agentid=${value}"
			   method="post">
		<%--<form:hidden path="evaluateById" id="evaluateBy" ></form:hidden>
        <form:hidden path="evaluateId" id="ids" ></form:hidden>
        <form:hidden path="id"></form:hidden>--%>
		<form:hidden path="oldAgentid"></form:hidden>
		<form:hidden path="byFlag"></form:hidden>
		...
		<table align="center">
			<tr style="padding-top: 10px">
				...
				<td>
					<div class="controls">
						<sys:treeselect1 id="agentid" name="agentid"
										value="${oaRunProcess.agentid}" labelName="name"
										labelValue="${fns:getNameByID(oaRunProcess.agentid)}"
										title="用户" url="/sys/office/treeData?type=3" cssClass="input-xxlarge required"
										notAllowSelectParent="true"  cssStyle="width:500px"/>
			...
			<tr>
				...
				<td>
					<div class="controls">
						<sys:treeselect1 id="principalid" name="principalid"
										value="${oaRunProcess.principalid}" labelName="name"
										labelValue="${fns:getNameByID(oaRunProcess.principalid)}"
										title="用户" url="/sys/office/treeData?type=3" cssClass="input-xxlarge required"
			...
			<tr>
				<td colspan="2" align="center">
					<input id="akBtnSubmit" class="btn btn-primary" type="button" value="保 存">
				</td>
			</tr>
		</table>
	</form:form>
