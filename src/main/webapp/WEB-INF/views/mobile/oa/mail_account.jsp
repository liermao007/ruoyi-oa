...
<div style="background-color: #ffffff">
    ...
    <table style="width: 96%;border: 1px solid #DFDDDD;background-color: #F5F5F5;height: 340px" align="center">
        <form:form modelAttribute="mailAccount" action="${ctx}/oa/mailInfo/saveAccount" method="post" id="form1"
            ...
            <tr>
                <td style="padding-left: 10px;width:100px;text-align: right">邮件显示名称：</td>
                <td style="padding-top: 2px"><form:input path="mailName" htmlEscape="true" type="text"
                                                         style="width:180px;"></form:input>
                    <span class="help-inline"><font color="red">*</font> </span></td>
            </tr>

            <tr>
                <td style="padding-left: 10px;width:100px;text-align: right">端口号：</td>
                <td><form:input path="port" htmlEscape="true" type="text"
                                                         style="width:180px;" placeholder="例如：25"></form:input>
                    <span class="help-inline"><font color="red">*</font></span>
                </td>
            </tr>
            <tr>
                <td style="padding-left: 10px;width:100px;text-align: right">接收服务器：</td>
                <td ><form:input path="mailAccept" htmlEscape="true" type="text"
                                                         style="width:180px;" placeholder="例如：imap.qq.com"></form:input>
                     <span class="help-inline"><font color="red">*</font></span>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding-left: 10px;width:100px;text-align: right">发送服务器：</td>
                <td ><form:input path="mailSend" htmlEscape="true" type="text"
                                                         style="width:180px;" placeholder="例如：smtp.qq.com"></form:input>
                     <span class="help-inline"><font color="red">*</font></span>
                </td>
            </tr>

            <tr>
                <td style="padding-left: 10px;width:100px;text-align: right">用户名：</td>
            ...
            <tr>
                <td style="padding-left: 10px;width:100px;text-align: right">密码：</td>
                <td ><form:input path="password" htmlEscape="true" type="password"
                                                         style="width:180px;"></form:input>
                    <span class="help-inline"><font color="red">*</font> </span></td>
            </tr>
            <tr>
                <td style="padding-left: 10px;width:100px;text-align:right">
                </td>
                <td style="text-align:left">
                    <input type="submit" class="btn btn-primary" style="width: 50%" value="保存">　
            ...
            <tr style="text-align:left">
                ...
                <td style="text-align:left">
                    <a href="#myModal" role="button" class="btn btn-primary" style="width: 50%" data-toggle="modal">查看帮助</a>
                </td>
            </tr>
        </form:form>
    </table>
