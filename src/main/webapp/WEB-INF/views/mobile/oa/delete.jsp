...
//                document.getElementById("ss").innerHTML = "<div style='color: #ffffff;background-color: #EF8F00;width: 140px;height: 25px;text-align: center;position: relative;bottom: 30px;left: -250px;line-height: 20px'>未选中任何邮件</div>";
            ...
            if (confirm('彻底删除后邮件将无法恢复，您确定要删除吗？')) {
                form1.action = '${ctx}/oa/mailInfo/thoroughDelete?ids='+chestr+'&state=DELETED';
                form1.submit();
            }
        }
        ...
        function read() {
            ...
            form1.action = '${ctx}/oa/mailInfo/read?ids='+chestr+'&readMark=1&state=DELETED';
            form1.submit();
        }
...
//                document.getElementById("ss").innerHTML = "<div style='color: #ffffff;background-color: #EF8F00;width: 140px;height: 25px;text-align: center;position: relative;bottom: 30px;left: -250px;line-height: 20px'>未选中任何邮件</div>";
            ...
            form1.action = '${ctx}/oa/mailInfo/read?ids='+chestr+'&readMark=0&state=DELETED';
            form1.submit();
        }
        ...
        function send() {
            ...
            form1.action = '${ctx}/oa/mailInfo/remove?ids='+chestr+'&state=DELETED&state1=SENT';
            form1.submit();
        }
        //移动到收件箱
        function inbox() {
...
//                document.getElementById("ss").innerHTML = "<div style='color: #ffffff;background-color: #EF8F00;width: 140px;height: 25px;text-align: center;position: relative;bottom: 30px;left: -250px;line-height: 20px'>未选中任何邮件</div>";
            ...
            form1.action = '${ctx}/oa/mailInfo/remove?ids='+chestr+'&state=DELETED&state1=INBOX';
            form1.submit();
        }
...
<form:form id="form1" modelAttribute="mailInfo" action="" method="post"
    ...
    <div class="select_All">
        ...
        <input type="button" value="移动到收信箱" class="btn btn-success" onclick="inbox()">
...
<script>
    $(function(){
        ...
        $(window).scroll(function(){
            ...
            //下滚
            if(t<=p){
            var url='${ctx}/oa/mailInfo/getMailMore?state=DELETED&pageNo='+pageNo+'&pageSize='+pageSize;
