...
<head>
	...
	<script type="text/javascript">
        ...
        url = getQueryString("child", "${url}") == 'role' ? "${ctx}/sys/role/treeData" : "${ctx}/sys/user/treeData";
...
<body style="position: fixed;overflow: auto">
	...
	<%--</div>--%>
	<div id="tree" class="ztree" style="padding:15px 20px; position: absolute; -webkit-overflow-scrolling: touch;"></div>
</body>