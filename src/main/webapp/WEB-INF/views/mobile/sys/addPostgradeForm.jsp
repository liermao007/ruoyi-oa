...
<body>
    <ul class="breadcrumb">
        ...
        <li class="active">
            <shiro:hasPermission name="sys:dict:edit">${not empty dict.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:dict:edit">查看</shiro:lacksPermission>
        </li>
    </ul>
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/addPostgrade/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
