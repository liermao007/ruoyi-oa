                    ...
                    <c:forEach  items="${list861100292}" var="hospitalMasterIndex" varStatus="i">
                        ...
                        <c:if test="${hospitalMasterIndex.org == '861100292'}">
                                <tr name="people">
                                    ...
                                    <td id="people20${i.count}">${hospitalMasterIndex.groupCashBudgetaryAmountMonths == 0 ? "" : fns:getMathUtils(hospitalMasterIndex.groupCashBudgetaryAmountMonths,2)}</td>
                                    <td id="people21${i.count}">${hospitalMasterIndex.groupCashActualAmountMonths == 0 ? "" : fns:getMathUtils(hospitalMasterIndex.groupCashActualAmountMonths,2)}</td>
                                    <td id="people4${i.count}">${((hospitalMasterIndex.groupCashActualAmountMonths == 0 ? "" : fns:getMathUtils(hospitalMasterIndex.groupCashActualAmountMonths,2))/
