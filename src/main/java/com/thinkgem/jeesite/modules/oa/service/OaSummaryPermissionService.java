...
public class OaSummaryPermissionService extends CrudService<OaSummaryPermissionDao, OaSummaryPermission> {
    ...
    @Autowired
    private OaSummaryPermissionDao oaSummaryPermissionDao;
    ...
    public List<OaSummaryPermission> findListByLoginId(String loginId) {
        return oaSummaryPermissionDao.findListByLoginId(loginId);
    }
