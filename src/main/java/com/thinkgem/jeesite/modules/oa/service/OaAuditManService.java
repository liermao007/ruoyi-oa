...
public class OaAuditManService extends CrudService<OaAuditManDao, OaAuditMan> {
    ...
    public Page<OaAuditMan> findListbByCompanyId(Page<OaAuditMan> page, OaAuditMan oaAuditMan) {

        oaAuditMan.setPage(page);
        page.setList(dao.findListbByCompanyId(oaAuditMan));
        return page;
    }
